...
project = 'boomerang'
copyright = '2018, Stearns Financial Services'
...
#
# html_theme = 'alabaster'  #  We prefer "read the docs".
# For more info about the sphinx_rtd_theme go to https://github.com/rtfd/sphinx_rtd_theme
...
latex_documents = [
    (master_doc, 'boomerang.tex', 'boomerang Documentation',
     'Stearns Financial Services', 'manual'),
]
...
man_pages = [
    (master_doc, 'boomerang', 'boomerang Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'boomerang', 'boomerang Documentation',
     author, 'boomerang', 'One line description of project.',
     'Miscellaneous'),
]
