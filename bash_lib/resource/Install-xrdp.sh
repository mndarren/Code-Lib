#!/bin/bash
# check off checkbox LocalResources/Printers and Smart cards, check on the Drives
echo
/bin/echo -e "\e[1;36m   !-------------------------------------------------------------!\e[0m"
/bin/echo -e "\e[1;36m   !   Custom XRDP Installation Script  - Ver 1.0.1              !\e[0m"
/bin/echo -e "\e[1;36m   !-------------------------------------------------------------!\e[0m"
echo
...
sudo apt-get -y install libx11-dev libxfixes-dev libssl-dev libpam0g-dev libtool libjpeg-dev flex bison openssh-server gettext autoconf libxml-parser-perl libfuse-dev xsltproc libxrandr-dev python-libxml2 nasm xserver-xorg-dev fuse pkg-config git intltool xserver-xorg-core
...
if grep -xq "#fixGDM-by-StearnsBank" /etc/xrdp/startwm.sh; then
...
/bin/echo -e "\e[1;33m    |-| Download StearnsBank image file...   \e[0m"
#Download the StearnsBank background 
wget http://advantagemachineryonline.com/wp-content/uploads/StearnsBank-white.png
