param ($uploadFileFrom, $uploadLocation, $uploadFilename, $ssoTokenUrl, $ssoClientId, $ssoClientSecret, $ssoScope, $ssoGrantType)
Write-Host
...
$url = 'https://app-it-oslo-stg.azurewebsites.net/api/reports/uploadcontrol'
